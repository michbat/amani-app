            ...
            (y = {
                init: function () {
                    (m.animating = !1),
                        ...
                        (m.atEnd =
                            0 === m.currentSlide || m.currentSlide === m.last),
                        ...
                        "slide" === m.vars.animation &&
                            (m.vars.animation = "swing"),
                        (m.prop = g
                            ? "top"
                            : m.vars.rtl
                            ? "marginRight"
                        ...
                        (m.ensureAnimationEnd = "") !==
                            m.vars.controlsContainer &&
                            (m.controlsContainer =
                ...
                asNav: {
                    setup: function () {
                        (m.asNav = !0),
                            (m.animatingTo = Math.floor(
                                m.currentSlide / m.move
                            )),
                ...
                controlNav: {
                    ...
                    setupPaging: function () {
                        ...
                        m.controlsContainer
                            ? b(m.controlsContainer).append(
                                  m.controlNavScaffold
                              )
                            : m.append(m.controlNavScaffold),
                            y.controlNav.set(),
                            y.controlNav.active(),
                            m.controlNavScaffold.delegate(
                                "a, img",
                                o,
                                function (e) {
                                    if (
                    ...
                    set: function () {
                        var e =
                            "thumbnails" === m.vars.controlNav ? "img" : "a";
                        m.controlNav = b(
                            "." + d + "control-nav li " + e,
                ...
                pausePlay: {
                    setup: function () {
                        ...
                        m.controlsContainer
                            ...
                            y.pausePlay.update(
                                m.vars.slideshow ? d + "pause" : d + "play"
                            ),
                ...
                smoothHeight: function (e) {
                    if (!g || x) {
                        ...
                        e
                            ...
                            : t.innerHeight(
                                  m.slides.eq(m.animatingTo).innerHeight()
                              );
                    }
                },
                sync: function (e) {
                ...
                if (
                    ...
                    if (
                        ...
                        var s,
                            ...
                            l,
                            c = g
                                ? m.slides.filter(":first").height()
                                : m.computedW;
                        (o = S
                            ? ((s = m.vars.itemMargin),
                              (l = (m.itemW + s) * m.move * m.animatingTo) >
                                  m.limit && 1 !== m.visible
                                  ? m.limit
                                  : l)
                            : 0 === m.currentSlide &&
                            ...
                            m.transitions
                                ? ((m.vars.animationLoop && m.atEnd) ||
                                  ...
                                  clearTimeout(m.ensureAnimationEnd),
                                  (m.ensureAnimationEnd = setTimeout(
                                      function () {
                                          m.wrapup(c);
                                      },
                    ...
                    m.vars.smoothHeight &&
                        y.smoothHeight(m.vars.animationSpeed);
                }
            }),
            (m.wrapup = function (e) {
                x ||
                        ...
                        ? ((m.itemT = m.vars.itemWidth + t),
                          ...
                          (m.move =
                              0 < m.vars.move && m.vars.move < m.visible
                                  ? m.vars.move
                                  : m.visible),
                          (m.pagingCount = Math.ceil(
                              (m.count - m.visible) / m.move + 1
                          )),
