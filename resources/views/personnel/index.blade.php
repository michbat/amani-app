...
@section('title', 'personnel index page')
@section('custom_css')
    <style>
        .col-4 a {
...
@section('content')
    <div style="margin-top: 80px;">
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="col-4">
                <a href="{{ route('personnel.plats.index') }}">
                    <div class="card">
            ...
            <div class="col-4">
                <a href="{{ route('personnel.ingredients.index') }}">
                    <div class="card">
                        <div class="card-body bg-info" style="color: #333">
            ...
            <div class="col-4">
                <a href="{{ route('personnel.orders.index') }}">
                    <div class="card">
            ...
            <div class="col-4">
                <a href="{{ route('personnel.tables.index') }}">
                    <div class="card">
                        <div class="card-body bg-warning" style="color: #333">
