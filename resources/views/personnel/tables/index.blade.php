...
@section('content')
    <div class="d-flex mt-5 justify-content-end">
        <a class="btn btn-info btn-lg text-dark"
            href="{{ route('personnel.tables.create') }}"><i class="fas fa-plus mx-2"></i>Ajouter une table</a>
    </div>
    <div class="card mt-3">
                        ...
                        @foreach ($tables as $table)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('personnel.tables.setisfree', $table->id) }}">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a class="btn btn-primary mx-2 text-dark"
                                            href="{{ route('personnel.tables.edit', $table->id) }}"><i
                                                class="fas fa-edit mx-2"></i>Editer</a>

                                        <form action="{{ route('personnel.tables.destroy', $table->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
