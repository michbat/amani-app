...
@section('content')
    <div class="d-flex mt-5 justify-content-end">
        <a class="btn btn-info btn-lg text-dark" href="{{ route('personnel.categories.create') }}"><i class="fas fa-plus mx-2"></i>Ajouter une
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a class="btn btn-primary text-dark mx-2"
                                            href="{{ route('personnel.categories.edit', $category->id) }}"><i
                                                class="fas fa-edit mx-2"></i>Editer</a>

                                        <form action="{{ route('personnel.categories.destroy', $category->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
