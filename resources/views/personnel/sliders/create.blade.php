...
@section('content')
    ...
    <div class="card mt-3">
        <form action="{{ route('personnel.sliders.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                <div class="form-group row mb-4">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="title" id="title"
                            placeholder="Titre du slider" value="{{ old('title') }}">
                ...
                <div class="form-group row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea name="content" id="tiny" cols="30" rows="30" class="form-control"></textarea>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12">
                        <div id="image-preview" class="image-preview mb-2 w-100">
