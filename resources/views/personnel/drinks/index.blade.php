...
@section('content')
    <div class="d-flex mt-5 justify-content-end">
        <a class="btn btn-info btn-lg text-dark" href="{{ route('personnel.drinks.create') }}"><i
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-primary text-dark mx-2"
                                            href="{{ route('personnel.drinks.edit', $drink->id) }}"><i
                                                class="fas fa-edit mx-2"></i>Editer</a>

                                        <form action="{{ route('personnel.drinks.destroy', $drink->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
