...
@section('title', 'Artist Index')

@section('content')
    <div class="d-flex mt-5 justify-content-end">
        <a class="btn btn-info btn-lg text-dark" href="{{ route('personnel.artists.create') }}"><i
                class="fas fa-plus mx-2"></i>Ajouter un artiste</a>
    </div>
    <div class="card mt-3">
        <div class="card-header">
            <div class="card-header d-flex flex-column justify-content-center align-items-start">
                ...
                <p>{{ $artists->firstItem() }} à {{ $artists->lastItem() }} sur {{ $artists->total() }} artiste(s)</p>
            </div>
        </div>
        <div class="card-body">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a class="btn btn-primary mx-2 text-dark"
                                            href="{{ route('personnel.artists.edit', $artist->id) }}"><i
                                                class="fas fa-edit mx-2"></i>Editer</a>

                                        <form action="{{ route('personnel.artists.destroy', $artist->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
    ...
    <script>
        ...
        $('.confirm').click(function(event) {
            ...
            Swal.fire({
                ...
                text: "Voulez-vous supprimer cet artiste ?",
