...
@section('content')
    <div class="d-flex mt-5 justify-content-end">
        <a class="btn btn-info btn-lg text-dark" href="{{ route('personnel.units.create') }}"><i
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a class="btn btn-primary mx-2 text-dark"
                                            href="{{ route('personnel.units.edit', $unit->id) }}"><i
                                                class="fas fa-edit mx-2"></i>Editer</a>

                                        <form action="{{ route('personnel.units.destroy', $unit->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
