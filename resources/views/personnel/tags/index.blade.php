...
@section('content')
    <div class="d-flex mt-5 justify-content-end">
        <a class="btn btn-info btn-lg text-dark" href="{{ route('personnel.tags.create') }}"><i
    ...
    <div class="card mt-3">
        <div class="card-header">
            <div class="card-header d-flex flex-column justify-content-center align-items-start">
                ...
                <p>{{ $tags->firstItem() }} à {{ $tags->lastItem() }} sur {{ $tags->total() }} tag(s)</p>
            </div>
        </div>
        <div class="card-body">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a class="btn btn-primary mx-2 text-dark"
                                            href="{{ route('personnel.tags.edit', $tag->id) }}"><i
                                                class="fas fa-edit mx-2"></i>Editer</a>

                                        <form action="{{ route('personnel.tags.destroy', $tag->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
