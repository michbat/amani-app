...
class TableController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.tables.index')->with('toast_success', 'Table ajoutée');
    }
    ...
    public function update(Request $request, Table $table)
    {
        ...
        return redirect()->route('admin.tables.index')->with('toast_success', 'Table éditée');
    }
    ...
    {
        $table->delete();
        return redirect()->route('admin.tables.index')->with('toast_success', 'Table supprimée');
    }
