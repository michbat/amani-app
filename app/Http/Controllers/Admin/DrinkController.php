...
class DrinkController extends Controller
{
    ...
    public function store(DrinkCreateRequest $request)
    {
        ...
        return redirect()->route('admin.drinks.index')->with('toast_success', 'La boisson a été ajoutée avec succès');
    }
    ...
    public function update(DrinkEditRequest $request, Drink $drink)
    {
        ...
        return redirect()->route('admin.drinks.index')->with('toast_success', 'La boisson a été mise à jour avec succès');
    }
    ...
    public function destroy(Drink $drink)
    {
        ...
        return redirect()->route('admin.drinks.index')->with('toast_success', 'Le menu a été supprimé avec succès');
    }
}
