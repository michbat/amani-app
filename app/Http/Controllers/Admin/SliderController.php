...
class SliderController extends Controller
{
    ...
    public function store(SliderCreateRequest $request)
    {
        ...
        return redirect()->route('admin.sliders.index')->with('toast_success', 'Le slider a été ajouté avec succès');
    }
    ...
    public function update(SliderEditRequest $request, Slider $slider)
    {
        ...
        return redirect()->route('admin.sliders.index')->with('toast_success', 'Le slider a été mis à jour');
    }
    ...
    public function destroy(Slider $slider)
    {
        ...
        return redirect()->route('admin.sliders.index')->with('toast_success', 'Le slider a été supprimé');
    }
}
