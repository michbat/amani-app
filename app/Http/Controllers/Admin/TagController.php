...
class TagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.tags.index')->with('toast_success', 'Le tag a été ajouté avec succès');
    ...
    public function update(Request $request, Tag $tag)
    {
        ...
        return redirect()->route('admin.tags.index')->with('toast_success', 'Le tag a été mis à jour avec succès');
    ...
    public function destroy(Tag $tag)
    {
        ...
        return redirect()->route('admin.tags.index')->with('toast_success', 'Le tag a été supprimé avec succès');
    }
}
