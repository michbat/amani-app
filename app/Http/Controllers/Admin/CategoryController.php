...
class CategoryController extends Controller
{
    ...
    public function store(CategoryCreateRequest $request)
    {
        ...
        return redirect()->route('admin.categories.index')->with('toast_success', 'La catégorie a été crée avec succès');
    ...
    public function update(CategoryEditRequest $request, Category $category)
    {
        ...
        return redirect()->route('admin.categories.index')->with('toast_success', 'La catégorie a été mise à jour avec succès');
    }
    ...
    public function destroy(Category $category)
    {
        ...
        return redirect()->route('admin.categories.index')->with('toast_success', 'La catégorie a été supprimée');
    }
}
