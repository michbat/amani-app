...
class StaffPersonnelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('personnel.staffs.index', compact('staffs'));
    }
    ...
    {
        return view('personnel.staffs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('personnel.staffs.index')->with('toast_success', 'Le nouveau membre du personnel a été ajouté avec succès');
    }
    ...
    {
        return view('personnel.staffs.edit', compact('staff'));
    }
    ...
    public function update(Request $request, Staff $staff)
    {
        ...
        return redirect()->route('personnel.staffs.index')->with('toast_success', 'Le membre du personnel a été mis à jour');
    }
    ...
    public function destroy(Staff $staff)
    {
        ...
        return redirect()->route('personnel.staffs.index')->with('toast_success', 'Le membre du personnel a été supprimé de la galerie');
    }
}
