...
class GalleryPersonnelController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('personnel.galleries.index', compact('galleries'));
    }
    ...
    public function create()
    {
        ...
        return view('personnel.galleries.create', compact('types'));
    }
    ...
    public function store(GalleryCreateRequest $request)
    {
        ...
        return redirect()->route('personnel.galleries.index')->with('toast_success', 'Le média a été ajouté à la galerie');
    ...
    {
        $types = GalleryType::cases();
        return view('personnel.galleries.edit', compact('gallery', 'types'));
    }
    ...
    public function update(GalleryEditRequest $request, Gallery $gallery)
    {
        ...
        return redirect()->route('personnel.galleries.index')->with('toast_success', 'Le média a été édité avec succès');
    ...
    public function destroy(Gallery $gallery)
    {
        ...
        return redirect()->route('personnel.galleries.index')->with('toast_success', 'Le média a été supprimée de la galerie');
    }
}
