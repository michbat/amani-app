...
class RepresentationPersonnelController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('personnel.representations.index', compact('representations'));
    }
    ...
    public function create()
    {
        ...
        return view('personnel.representations.create', compact('shows'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('personnel.representations.index')->with('toast_success', 'Programmation ajoutée avec succès');
    }
    ...
    public function edit(Representation $representation)
    {
        ...
        return view('personnel.representations.edit', compact('shows', 'representation'));
    }
    ...
    public function update(Request $request, Representation $representation)
    {
        ...
        return redirect()->route('personnel.representations.index')->with('toast_success', 'Programmation éditée avec succès');
    }
    ...
    public function destroy(Representation $representation)
    {
        ...
        return redirect()->route('personnel.representations.index')->with('toast_success', 'Programmation supprimée avec succès');
    }
}
