...
class TypePersonnelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('personnel.types.index', compact('types'));
    }
    ...
    {
        return view('personnel.types.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('personnel.types.index')->with('toast_success', 'Le type de produits a été ajouté avec succès');
    }
    ...
    {
        return view('personnel.types.edit', compact('type'));
    }
    ...
    public function update(Request $request, Type $type)
    {
        ...
        return redirect()->route('personnel.types.index')->with('toast_success', 'Le type de produits a été mis à jour avec succès');
    }
    ...
    {
        $type->delete();
        return redirect()->route('personnel.types.index')->with('toast_success', 'Le type de produits a été supprimé avec succès');
