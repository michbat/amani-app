...
class ShowPersonnelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('personnel.shows.index', compact('shows'));
    }
    ...
    public function create()
    {
        ...
        return view('personnel.shows.create', compact('bands'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('personnel.shows.index')->with('toast_success', 'Le spectacle a été ajouté avec success');
    }
    ...
    {
        $bands = Band::orderBy('name')->get();
        return view('personnel.shows.edit', compact('bands', 'show'));
    }
    ...
    public function update(Request $request, Show $show)
    {
        ...
        return redirect()->route('personnel.shows.index')->with('toast_success', 'Le spectacle a été mis à jour');
    }
    ...
    public function destroy(Show $show)
    {
        ...
        return redirect()->route('personnel.shows.index')->with('toast_success', 'Le spectacle a été supprimé');
    }
}
