...
class DetailsComponent extends Component
{
    ...
    public function storePlat($plat_id, $plat_name, $plat_price)
    {
        ...
        /**
         * Si on a déjà ajouté un plat dans le panier, on vérifie pour chaque ingrédient qui le compose
         * si sa quantité en stock à laquelle on retranche la quantité de l'ingrédient entrant dans la composition de notre plat multiplie
